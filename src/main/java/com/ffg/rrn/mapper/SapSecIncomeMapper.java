...
public class SapSecIncomeMapper implements RowMapper<DemographicChoice> {
	
	public static final String SSI_SQL //
	= "select choice_id, choice from DEMOGRAPHICS_CHOICES where type='SSI'"; 
