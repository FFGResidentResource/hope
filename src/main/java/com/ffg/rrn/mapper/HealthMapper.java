...
public class HealthMapper implements RowMapper<DemographicChoice> {
	
	public static final String HLTH_SQL //
	= "select choice_id, choice from DEMOGRAPHICS_CHOICES where type='Health'"; 
