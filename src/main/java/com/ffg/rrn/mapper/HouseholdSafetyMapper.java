...
public class HouseholdSafetyMapper implements RowMapper<DemographicChoice> {
	
	public static final String HHST_SQL //
	= "select choice_id, choice from DEMOGRAPHICS_CHOICES where type='HouseholdSafety'"; 
