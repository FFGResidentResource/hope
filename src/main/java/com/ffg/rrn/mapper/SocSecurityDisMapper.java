...
public class SocSecurityDisMapper implements RowMapper<DemographicChoice> {
	
	public static final String SSDI_SQL //
	= "select choice_id, choice from DEMOGRAPHICS_CHOICES where type='SSDI'"; 
