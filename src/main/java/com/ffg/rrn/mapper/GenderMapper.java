...
public class GenderMapper implements RowMapper<DemographicChoice> {
	
	public static final String GEND_SQL //
	= "select choice_id, choice from DEMOGRAPHICS_CHOICES where type='Gender'"; 
