...
public class EthnicityMapper implements RowMapper<DemographicChoice> {
	
	public static final String ETHCTY_SQL //
	= "select choice_id, choice from DEMOGRAPHICS_CHOICES where type='Ethnicity'"; 
