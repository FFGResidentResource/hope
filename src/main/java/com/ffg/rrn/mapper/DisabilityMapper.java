...
public class DisabilityMapper implements RowMapper<DemographicChoice> {
	
	public static final String DISA_SQL //
	= "select choice_id, choice from DEMOGRAPHICS_CHOICES where type='Disability'"; 
