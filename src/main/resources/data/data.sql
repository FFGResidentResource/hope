...
CREATE TABLE ACTION_PLAN(
	...
	RESIDENT_CONCERN        VARCHAR(500),
        ...
        FOCUS_ON_DOMAIN 	JSON,
	PLAN_OF_ACTION		JSON,
	ANTICIPATED_OUTCOME	JSON,
	OUTCOME_ACHIEVED	JSON,
...
alter table ACTION_PLAN
  add constraint RESIDENT_ID_FK1 foreign key (RESIDENT_ID)
  references RESIDENT(RESIDENT_ID); 
  
  alter table ACTION_PLAN
  alter COLUMN PLAN_OF_ACTION SET DEFAULT '{ "HOUSING": "", "MONEY MANAGEMENT": "", "EMPLOYMENT": "", "EDUCATION": "", "NETWORK SUPPORT": "", "HOUSEHOLD MANAGEMENT": "" }'::JSON;
  ; 


alter table ACTION_PLAN
  alter COLUMN ANTICIPATED_OUTCOME SET DEFAULT '{ "HOUSING": "", "MONEY MANAGEMENT": "", "EMPLOYMENT": "", "EDUCATION": "", "NETWORK SUPPORT": "", "HOUSEHOLD MANAGEMENT": "" }'::JSON;
  ; 

alter table ACTION_PLAN
  alter COLUMN OUTCOME_ACHIEVED SET DEFAULT '{ "HOUSING": "", "MONEY MANAGEMENT": "", "EMPLOYMENT": "", "EDUCATION": "", "NETWORK SUPPORT": "", "HOUSEHOLD MANAGEMENT": "" }'::JSON;
  ; 
