...
DROP MATERIALIZED VIEW if exists SERVICE_CATEGORY_VW;
DROP MATERIALIZED VIEW if exists NEW_RESIDENT_VW;
DROP MATERIALIZED VIEW if exists ONGOING_RESIDENT_VW;

DROP TABLE if exists REFERRAL_FORM;
DROP TABLE if exists ACTION_PLAN;
DROP TABLE if exists CASE_NOTES;
DROP TABLE if exists RESIDENT_SCORE_GOAL;
