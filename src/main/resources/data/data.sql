...
INSERT INTO ASSESSMENT_QUESTIONNAIRE VALUES(nextval('AQ_SQ'), 1,'Are you able to keep your home clean and organized?', 'HOUSEHOLD MANAGEMENT',40);
INSERT INTO ASSESSMENT_QUESTIONNAIRE VALUES(nextval('AQ_SQ'), 2,'Are you able to do laundry and have clean clothes available for your family members?', 'HOUSEHOLD MANAGEMENT',41);
INSERT INTO ASSESSMENT_QUESTIONNAIRE VALUES(nextval('AQ_SQ'), 3,'Do you do the dishes after each meal and keep the kitchen clean?', 'HOUSEHOLD MANAGEMENT',42);
INSERT INTO ASSESSMENT_QUESTIONNAIRE VALUES(nextval('AQ_SQ'), 4,'Do you regularly take out the trash and recycle?', 'HOUSEHOLD MANAGEMENT',43);
INSERT INTO ASSESSMENT_QUESTIONNAIRE VALUES(nextval('AQ_SQ'), 5,'Are you able to plan and prepare meals on a regular basis?', 'HOUSEHOLD MANAGEMENT',44);
INSERT INTO ASSESSMENT_QUESTIONNAIRE VALUES(nextval('AQ_SQ'), 6,'Are you able to replenish household supplies before you run out (i.e., laundry detergent, toilet paper, etc.)?', 'HOUSEHOLD MANAGEMENT',45);
INSERT INTO ASSESSMENT_QUESTIONNAIRE VALUES(nextval('AQ_SQ'), 7,'Are you able to maintain the outside of your home, if required (i.e., yard, sidewalks, etc.)?', 'HOUSEHOLD MANAGEMENT',46);
