function calculateHousingScore() {
	...
	if (qChoice1[1].checked == true) {
		...
		jQuery('input[id^=_housingQuestionnaire_2]').prop('checked', false);
		jQuery('input[id^=_housingQuestionnaire_3]').prop('checked', false);
		jQuery('input[id^=_housingQuestionnaire_4]').prop('checked', false);
		jQuery('input[id^=_housingQuestionnaire_5]').prop('checked', false);
		jQuery('input[id^=_housingQuestionnaire_6]').prop('checked', false);
		jQuery('input[id^=_housingQuestionnaire_7]').prop('checked', false);
		jQuery('input[id^=_housingQuestionnaire_8]').prop('checked', false);

		jQuery('input[id^=_housingQuestionnaire_2]').prop('disabled', true);
		jQuery('input[id^=_housingQuestionnaire_3]').prop('disabled', true);
		jQuery('input[id^=_housingQuestionnaire_4]').prop('disabled', true);
		jQuery('input[id^=_housingQuestionnaire_5]').prop('disabled', true);
		jQuery('input[id^=_housingQuestionnaire_6]').prop('disabled', true);
		jQuery('input[id^=_housingQuestionnaire_7]').prop('disabled', true);
		jQuery('input[id^=_housingQuestionnaire_8]').prop('disabled', true);

	} else {

		jQuery('input[id^=_housingQuestionnaire_2]').prop('disabled', false);
		jQuery('input[id^=_housingQuestionnaire_3]').prop('disabled', false);
